...
import com.example.geostreamtv.databinding.FragmentFirstBinding;
...
public class FirstFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.buttonLiveTraining.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.buttonMeals.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
